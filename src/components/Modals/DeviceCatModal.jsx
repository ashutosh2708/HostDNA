...
const schema = Yup.object({
  deviceCategory: Yup.string()
    .required("Device category is required")
    .matches(/^[A-Za-z .*\\S+.]*$/, "Please enter valid  device category")
    .min(6, "Mininum 6 characters")
    .max(20, "Maximum 20 characters"),
});

const DeviceCatModal = () => {
          ...
          <div className="bg-white border p-8">
            ...
            <fieldset className="border border-gray-400 rounded">
              <legend className="px-2 ml-4">
                <h6 className="font-semibold">Add Device Category</h6>
              </legend>
              <div className="grid md:grid-cols-2 gap-2 p-4">
                <div>
                  <TextField
                    ...
                    error={Boolean(errors.deviceCategory)}
                    helperText={errors.deviceCategory?.message}
                  />
                </div>
                <div className="flex">
                  <div className="">
